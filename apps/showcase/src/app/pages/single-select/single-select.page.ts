...
export class SingleSelectPage {
  ...
  protected readonly docsPath = '/docs/libs/ui-components/coar-single-select.docs.md';
  protected readonly apiPath = '/docs/libs/ui-components/coar-single-select.api.md';
