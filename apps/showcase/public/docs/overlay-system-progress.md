...
- [.local/overlay-system.md](../.local/overlay-system.md)
...
Key files:
- [libs/ui-overlay/src/lib/overlay/overlay-spec.ts](../libs/ui-overlay/src/lib/overlay/overlay-spec.ts)
- [libs/ui-overlay/src/lib/overlay/overlay-builder.ts](../libs/ui-overlay/src/lib/overlay/overlay-builder.ts)
- [libs/ui-overlay/src/lib/overlay/overlay.ts](../libs/ui-overlay/src/lib/overlay/overlay.ts)
- [libs/ui-overlay/src/lib/overlay/deep-freeze.ts](../libs/ui-overlay/src/lib/overlay/deep-freeze.ts)
...
Key files:
- [libs/ui-overlay/src/lib/overlay/content-builder.ts](../libs/ui-overlay/src/lib/overlay/content-builder.ts)
...
Key file:
- [libs/ui-overlay/src/lib/overlay/presets.ts](../libs/ui-overlay/src/lib/overlay/presets.ts)
...
Key files:
- [libs/ui-overlay/src/lib/overlay/overlay.spec.ts](../libs/ui-overlay/src/lib/overlay/overlay.spec.ts)
- [libs/ui-overlay/src/lib/overlay/overlay-service.spec.ts](../libs/ui-overlay/src/lib/overlay/overlay-service.spec.ts)
- [libs/ui-overlay/src/lib/overlay/overlay-position.spec.ts](../libs/ui-overlay/src/lib/overlay/overlay-position.spec.ts)
...
Key files:
- [libs/ui-tokens/src/css/layers.css](../libs/ui-tokens/src/css/layers.css)
- [libs/ui-overlay/src/lib/overlay/overlay-service.ts](../libs/ui-overlay/src/lib/overlay/overlay-service.ts)
