...
import { configureGlobalLogger, getLogger, getLoggerFor, resetGlobalLogger } from './global-logger';
...
describe('Global Logger', () => {
  ...
  describe('configureGlobalLogger', () => {
    ...
    it('should share configuration across all getLogger calls', () => {
      configureGlobalLogger((config) => config.minLevel('warn'));
    ...
    it('should allow reconfiguration', () => {
      const firstLogger = configureGlobalLogger((config) => config.minLevel('info'));

      const secondLogger = configureGlobalLogger((config) => config.minLevel('debug'));
  ...
  describe('resetGlobalLogger', () => {
    it('should reset the global logger configuration', () => {
      const firstLogger = configureGlobalLogger((config) => config.minLevel('debug'));
