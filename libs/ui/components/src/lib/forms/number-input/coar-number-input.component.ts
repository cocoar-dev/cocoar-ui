...
import { CoarIconComponent, CoarIconSize } from '../../display/icon/coar-icon.component';
import { CoarControlValueAccessor, coarProvideValueAccessor } from '../_base/coar-control-value-accessor';
