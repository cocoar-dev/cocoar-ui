...
@Component({
  ...
  host: {
    ...
    '[class.coar-plain-date-time-picker--s]': 'size() === "s"',
    '[class.coar-plain-date-time-picker--m]': 'size() === "m"',
    '[class.coar-plain-date-time-picker--l]': 'size() === "l"',
...
export class CoarPlainDateTimePickerComponent extends CoarDatePickerBase<Temporal.PlainDateTime> {
  ...
  protected override readonly uid = `coar-plain-date-time-picker-${CoarPlainDateTimePickerComponent.nextId++}`;
