...
const classNameToSourcePath = {
  ...
  CoarMiniCalendarComponent: 'libs/ui-components/src/lib/coar-mini-calendar',
  ...
  CoarPlainDatePickerComponent: 'libs/ui-components/src/lib/coar-plain-date-picker',
  CoarPlainDateTimePickerComponent: 'libs/ui-components/src/lib/coar-plain-date-time-picker',
  ...
  CoarTimePickerComponent: 'libs/ui-components/src/lib/coar-time-picker',
