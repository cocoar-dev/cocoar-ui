...
const REFERENCE_DIR = join(ROOT_DIR, 'docs/reference');
...
function generateMarkdownReference(components) {
  ...
  lines.push('');
  lines.push('This file is auto-generated by `scripts/docs/extract-component-api.mjs`.');
  lines.push('');
  lines.push('Install:');
  lines.push('');
  lines.push('```bash');
...
async function main() {
  ...
  writeFileSync(
    jsonPath,
    JSON.stringify(generateJsonReference(allComponents), null, 2) + '\n',
    'utf-8'
  );
